									...
									<div class="col-lg-12">
											<div class="form-group">
												...
												<select name="genre" class="form-control @error('genre') is-invalid @enderror" id="">
													<option selected>Par Defaut</option>
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input id="name" name="nom" class="form-control @error('nom') is-invalid @enderror" type="text" placeholder="">
                                                        @error('nom')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="prenom" id="name" class="form-control @error('prenom') is-invalid @enderror" type="text" placeholder="">
                                                @error('prenom')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="password_confirmation" class="form-control @error('password') is-invalid @enderror" type="password" placeholder="">
										...
										<div class="col-lg-12 col-12">
											<div class="form-group">
												...
												<input name="image" class="form-control @error('image') is-invalid @enderror" type="text" placeholder="">
                                                @error('image')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>

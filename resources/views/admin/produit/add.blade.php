    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class=" box-primary">
            ...
            <form role="form" action="{{ route('admin.produit.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                      ...
                      <input type="text" name="prix" class="form-control" id="exampleInputEmail1" placeholder="">
                    </div>
            ...
            <div class="box-body pad">
                ...
                <textarea name="detail" class="textarea" placeholder="La description de votre produit"

              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="Time" name="heure" class="form-control" id="exampleInputPassword1" placeholder="">
                  </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="lieu" class="form-control" id="exampleInputPassword1" placeholder="Lieu de votre service">
                    </div>
<br>
                    <div class="form-group">
